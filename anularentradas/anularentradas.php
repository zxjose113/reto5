...
<head>
    ...
    <title>ACCESO</title>
    <link rel="stylesheet" href="anular.css">
</head>
<body>
 <!--Caja de los menus-->
 <div class="head">
    ...
    <div class="menu">
        <ul>
            <li>
                <a>La carrera</a>
                <ul class="submenu">
                <li><a href="../clasificacion/clasificación.php">Clasificacion</a></li>
    ...
    <script src="anularentradas.js"></script>
</body>
</html>